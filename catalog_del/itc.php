...
<?else:?>
    ...
    <div class="product-description">
        <div class="product-description__head">
            <div class="product-description__head-product">
                        ...
                        <div id = "slider_pagination">
                            <?foreach($arImg as $arItem):?>
                                <div class="product-description__head-product_min-img_item">
                                    <img style="height: 100%; display: inline-block;" src="<?=$arItem['SRC']?>" alt="<?=$arResult['NAME']?>">
                                </div>
                            <?endforeach?>
                        </div>
                    </div>
                ...
                <?if(!empty($arResult["PROPERTIES"]['SHOW']["VALUE"])):?>
                    <a href="<?=$arResult["PROPERTIES"]['SHOW']["VALUE"]?>" class="product-description__head-product_demo">
                        Демонстрация продукта
                    </a>
                <?endif;?>
                <a href="javascript:void(0);" style = "bottom: 23px;"class="product-description__head-product_btn send-message" data-product='<?=$arResult['NAME']?>'>
                    Заказать
                </a>
            </div>
        ...
        <?if(!empty($arResult["PROPERTIES"]['DETAIL_TEXT']["VALUE"])):?>
            <div class="product-description__head-info_detail" id='detail-text-btn'>
				...
				<path fill-rule="evenodd" clip-rule="evenodd" d="M18.809 10.8894L18.809 8.90955L10.8894 8.90955L10.8894 0.989949H8.90946L8.90946 8.90955L0.989869 8.90955L0.989869 10.8894L8.90946 10.8894V18.809H10.8894V10.8894L18.809 10.8894Z" fill="#BBC5CD"/>
				</svg>
			</span>
            </div>
            ...
            <div class="product-description__head-info_detail hidden" id='detail-text-hidden-btn'>
				...
				<path fill-rule="evenodd" clip-rule="evenodd" d="M12.6 14.8994L14 13.4994L8.4 7.89941L14 2.29941L12.6 0.899414L7 6.49941L1.4 0.899414L0 2.29941L5.6 7.89941L0 13.4994L1.4 14.8994L7 9.29941L12.6 14.8994Z" fill="#BBC5CD"/>
				</svg>
			</span>
            </div>
        <?endif;?>
        <?if(count($arResult['DISPLAY_PROPERTIES']['IMAGES']['FILE_VALUE']) > 0):?>
            <div class="review-photo__photos lightgallery">
                <?foreach ($arResult['DISPLAY_PROPERTIES']['IMAGES']['FILE_VALUE'] as $IMAGE):?>
                    <a class="review-photo__photos_item" href='<?=$IMAGE['SRC']?>' id="<?=$this->GetEditAreaId($arItem['ID']);?>">
    ...
    <?if(!empty($arResult['SALES']) && count($arResult['SALES']) > 0):?>
                                ...
                                <div class="slider-action__slide_btn-wrap">
                                    <a href="<?=$sale['URL']?>" class="slider-action__slide_btn">
                                        ...
                                        <span class="slider-action__slide_btn-arrow">
											...
											<path fill-rule="evenodd" clip-rule="evenodd" d="M8.39062 0.92627L6.99062 2.32627L12.5906 7.92627H0.390625V9.92627H12.5906L6.99062 15.5263L8.39062 16.9263L16.3906 8.92627L8.39062 0.92627Z" fill="white"/>
											</svg>
										</span>
                                    </a>
                                </div>
        ...
        <?/*<div class="d-block d-md-none min-slider__arrow min-slider__arrow_left">
			<div class="min-slider__arrow_ico min-slider__arrow_ico-left">
				<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path opacity="0.54" fill-rule="evenodd" clip-rule="evenodd" d="M8.99414 16.4629L10.3941 15.0629L4.79414 9.46289L16.9941 9.46289L16.9941 7.46289L4.79414 7.46289L10.3941 1.86289L8.99414 0.46289L0.994141 8.46289L8.99414 16.4629Z" fill="#fff"/>
				</svg>
			</div>
		</div>
		<div class="min-slider__arrow min-slider__arrow_right d-block d-md-none">
			<div class="min-slider__arrow_ico min-slider__arrow_ico-right">
				<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path opacity="0.54" fill-rule="evenodd" clip-rule="evenodd" d="M8.00586 0.462891L6.60586 1.86289L12.2059 7.46289H0.00585938V9.46289H12.2059L6.60586 15.0629L8.00586 16.4629L16.0059 8.46289L8.00586 0.462891Z" fill="white"/>
				</svg>
			</div>
		</div>
		<div class="d-flex justify-content-center justify-content-md-end">
			<div class="slider-action__slide_nav d-flex align-items-center">
				<ul class="slider-action__slide-dots">
					<li class=" slider-action__slide-dot"></li>
					<li class="slider-action__slide-dot slider-action__slide-dot_active"></li>
					<li class="slider-action__slide-dot"></li>
					<li class="slider-action__slide-dot"></li>
					<li class="slider-action__slide-dot"></li>
				</ul>
				<div class="slider-action__slide_arrow">
					<svg width="60" height="22" viewBox="0 0 60 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M48.9989 0.554199L47.1803 2.3917L54.4545 9.7417H0.390625V12.3667H54.4545L47.1803 19.7167L48.9989 21.5542L59.3906 11.0542L48.9989 0.554199Z" fill="white"/>
					</svg>
				</div>
			</div>
		</div>*/?>
    ...
    <?if(stripos($APPLICATION->GetCurPage(), "1C_products")):?>
        ...
        <!--		<div class="product-description__version product-description__tab" id='versoins'>-->
        <!--			<div class="product-description__version_h3 h3">-->
        <!--				<h3>Версии</h3>-->
        <!--			</div>-->
        <!--			<div class="product-description__version_wrap">-->
        <!--				--><?//if(!empty($arResult['PRODUCT_VERSIONS']) && count($arResult['PRODUCT_VERSIONS']) > 0):
//					foreach($arResult['PRODUCT_VERSIONS'] as $version):
//						if(!empty($version['OLD_PRICE']) && $version['OLD_PRICE'] != $version['PRICE'])
//							$action = true;
//						?>
        <!--						<div class="product-description__version-item --><?//=($action ? ' product-description__version-item_action' : '')?><!--">-->
        <!--							<div class="product-description__version-item_name">-->
        <!--								--><?//=$version['NAME']?>
        <!--							</div>-->
        <!--							<div class="product-description__version-item_price">-->
        <!--								--><?//=$version['PRICE']?><!-- руб.-->
        <!--								--><?//if($action):?>
        <!--									<div class="product-description__version-item_price-action">--><?//=$version['OLD_PRICE']?><!-- руб.</div>-->
        <!--								--><?//endif;?>
        <!--							</div>-->
        <!--							<a class="product-description__version-item_btn send-message">-->
        <!--								Заказать-->
        <!--							</a>-->
        <!--						</div>-->
        <!--						--><?//
...
//				</div>*/?>
        ...
        <div class="product-description__variants product-description__tab" id='variants'>
            ...
            <div class="product-description__variants_wrap">
                ...
                <div class="product-description__variants_explanation">
                    * дополнительное количество часов работы специалиста по внедрению и настройке 1С, входящее в стоимость покупки
                </div>
            </div>
        </div>
                    ...
                    for ($i = 0; $i<=count($arResult["DISPLAY_PROPERTIES"]["doplic"]["DESCRIPTION"]); $i++) {
                        if ($arResult["DISPLAY_PROPERTIES"]["doplic"]["DESCRIPTION"][$i]) { ?>
                            ...
                            <div class="product-description__variants-row">
                                ...
                                <a href="javascript:void(0);" class="product-description__variants-row_btn send-message" data-product='<?=$arResult['NAME']?>'>
                                    Заказать
                                </a>
                            </div>
                        <?}
                        ...
                        <?foreach($arCompareRow as $key_elem => $elem):
                            ...
                            if($elem == '+'):?>
                                <span class="product-description__comparison-table_row-ico">
										...
										<path fill-rule="evenodd" clip-rule="evenodd" d="M5.6 11.1L1.4 6.9L0 8.3L5.6 13.9L17.6 1.9L16.2 0.5L5.6 11.1Z" fill="#27AE60"/>
										</svg>
									</span>
                            <?else:?>
                                <span class="product-description__comparison-table_row-ico">
										<svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M14 1.9L12.6 0.5L7 6.1L1.4 0.5L0 1.9L5.6 7.5L0 13.1L1.4 14.5L7 8.9L12.6 14.5L14 13.1L8.4 7.5L14 1.9Z" fill="#E9E9E9"/>
										</svg>
									</span>
                            <?endif;?>
                        <?endforeach;?>
    ...
    <!--			<div class="product-description__tabs_item product-description__tabs_item-active" data-tab='tab1'>-->
    <!--				--><?//=$arResult['PROPERTIES']['TAB1_TITLE']['VALUE']?>
    <!--			</div>-->
    <!--		--><?//endif?>
    <!--		--><?//if(!empty($arResult['PROPERTIES']['TAB2_TITLE']['VALUE'])):?>
    <!--			<div class="product-description__tabs_item" data-tab='tab2'>-->
    <!--				--><?//=$arResult['PROPERTIES']['TAB2_TITLE']['VALUE']?>
    <!--			</div>-->
    <!--		--><?//endif?>
    <!--		--><?//if(!empty($arResult['PROPERTIES']['TAB3_TITLE']['VALUE'])):?>
    <!--			<div class="product-description__tabs_item" data-tab='tab3'>-->
    <!--				--><?//=$arResult['PROPERTIES']['TAB3_TITLE']['VALUE']?>
    <!--			</div>-->
    <!--		--><?//endif?>
    <!--	</div>-->
    <?if(!empty($arResult['PROPERTIES']['TAB1_TITLE']['VALUE']) || !empty($arResult['PROPERTIES']['TAB2_TITLE']['VALUE']) || !empty($arResult['PROPERTIES']['TAB3_TITLE']['VALUE'])):?>
        <div class="product-description__tabs_mob d-block d-md-none">
            <select class="product__select-list_item-list">
                <?if(!empty($arResult['PROPERTIES']['TAB1_TITLE']['VALUE'])):?>
                    <option class="introduction-head__select-item_list-item"  value='versoins'><?=$arResult['PROPERTIES']['TAB1_TITLE']['VALUE']?></option>
                <?endif?>
                <?if(!empty($arResult['PROPERTIES']['TAB2_TITLE']['VALUE'])):?>
                    <option class="introduction-head__select-item_list-item"  value='variants'><?=$arResult['PROPERTIES']['TAB2_TITLE']['VALUE']?></option>
                <?endif?>
                <?if(!empty($arResult['PROPERTIES']['TAB3_TITLE']['VALUE'])):?>
                    <option class="introduction-head__select-item_list-item"  value='licencies'><?=$arResult['PROPERTIES']['TAB3_TITLE']['VALUE']?></option>
                <?endif?>
            </select>
        </div>
    <?endif?>
...
//            echo '<pre>';
//    var_dump($arFields['PROPERTY_PRICE_VALUE']);
//    echo '</pre>';
        echo "<div class='products-box__item grey_background tab3_item'>
                <div class='tab3_content'>
                    <div class='tab3-title blue_text'>{$arFields['NAME']}</div>
                    <div class='tab3-text'>{$arFields['PREVIEW_TEXT']}</div>
                </div>
                <div class='tab3-price'>
                    <div class='tab3-price_value'>".htmlspecialcharsBack($arFields['~PROPERTY_PRICE_VALUE'])."</div>
