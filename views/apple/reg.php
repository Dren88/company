                    ...
                    <form action="<?=PATH?>registration" method="post">
                        <table width="730" border="0" cellspacing="2" cellpadding="0" class="regtable">
                            ...
                            <tr>
                                ...
                                <td><input class="access" type="text" data-field="login" name="login_reg" /><span></span>
                                    <span class="info"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>Введите ваш email <span style="color:red;">*</span></td>
                                <td><input class="access" type="text" data-field="email" name="email_reg" /><span></span>
                                    <span class="info"></span>
                                </td>
                            </tr>
                            <tr>
...
<!--                            <tr>-->
<!--                                <td>-->
<!--                                    Введите цифры с картинки: <span style="color:red;">*</span><br />-->
<!--                                    <img src="--><?//=PATH?><!--libs/captcha/captcha.php" alt="" width="150" id="captcha" height="41" class="regcaptcha" />-->
<!--                                </td>-->
